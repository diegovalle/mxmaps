...
save(mxmunicipio.map,
  file = "data/mxmunicipio.map.RData",
  compress = "xz", version = 2
)
...
save(mxstate.topoJSON,
  file = "data/mxstate.topoJSON.RData",
  compress = "xz", version = 2
)
...
save(mxmunicipio.topoJSON,
  file = "data/mxmunicipio.topoJSON.RData",
  compress = "xz", version = 2
)
