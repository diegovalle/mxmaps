...
save(df_mxstate,
  file = "data/df_mxstate.RData",
  compress = "xz", version = 2
)

df_mxstate_2015 <- df_mxstate
save(df_mxstate_2015,
  file = "data/df_mxstate_2015.RData",
  compress = "xz", version = 2
)
...
save(df_mxmunicipio,
  file = "data/df_mxmunicipio.RData",
  compress = "xz", version = 2
)

df_mxmunicipio_2015 <- df_mxmunicipio
save(df_mxmunicipio_2015,
  file = "data/df_mxmunicipio_2015.RData",
  compress = "xz", version = 2
)
