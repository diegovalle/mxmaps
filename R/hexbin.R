                                  ...
                                  render = function()
                                  {
                                    ...
                                    if (self$show_labels) {
                                      df_mxstate_labels = structure(list(long = c(-107.424100471015, -107.424100471015,
                                                                                  ...
                                                                                  -79.5597331042505, -79.5597331042505), lat = c(11.3870924263946,
                                                                                                                                 ...
                                                                                                                                 0.66209242639456, -1.12540757360544, 2.44959242639456), state_abbr = c("BCS",
                                                                                                                                                                                                        "BC", "SIN", "SON", "NAY", "DGO", "GRO", "MICH", "COL", "JAL",
                                                                                                                                                                                                        "ZAC", "CHIH", "MOR", "MEX", "GTO", "AGS", "COAH", "OAX", "PUE",
                                                                                                                                                                                                        "DF", "QRO", "SLP", "NL", "CHPS", "TLAX", "HGO", "VER", "TAM",
                                                                                                                                                                                                        "TAB", "CAMP", "QROO", "YUC"), id = c("03", "02", "25", "26",
                                                                                                                                                                                                                                              "18", "10", "12", "16", "06", "14", "32", "08", "17", "15", "11",
                                                                                                                                                                                                                                              "01", "05", "20", "21", "09", "22", "24", "19", "07", "29", "13",
                                                                                                                                                                                                                                              "30", "28", "27", "04", "23", "31")), .Names = c("long", "lat",
                                                                                                                                                                                                                                                                                               "state_abbr", "id"), row.names = c("0", "1", "2", "3", "4", "5",
                                      ...
                                      choropleth = choropleth + geom_text(data = df_mxstate_labels, aes(long, lat, label = state_abbr, group = NULL), color = 'black')
                                    }
