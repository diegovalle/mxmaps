...
This document provides an example of how to use the `mxmaps` package to create an interactive web application with Shiny. The app displays a choropleth map of homicide rates in Mexico by state, and includes a slider to allow users to explore the data across different years.
...
hom <- crime %>%
  mutate(year = year(paste0(date, "-01"))) %>%
